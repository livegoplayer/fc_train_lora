...
# 其他设置
network_weights="/home/ubuntu/stable-diffusion-webui/models/Lora/candy_style_v1.safetensors"               # pretrained weights for LoRA network | 若需要从已有的 LoRA 模型上继续训练，请填写 LoRA 模型路径。
