...
$train_data_dir = "./train/mlsd/train" # train dataset path | 训练数据集路径
...
$output_name = "sdxl_cn3l" # output model name | 模型保存名称
...
#sdxk_cn3l
$conditioning_data_dir = "./train/mlsd/cond"
$cond_emb_dim = 128
...
# run train
python -m accelerate.commands.launch $launch_args --num_cpu_threads_per_process=8 "./sd-scripts/$laungh_script.py" `
